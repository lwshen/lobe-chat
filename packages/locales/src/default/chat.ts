export default {
  ...
  'workingPanel.overview.ports.addPlaceholder': 'Port number, Enter to open',
  'workingPanel.overview.ports.copied': 'Link copied',
  'workingPanel.overview.ports.copy': 'Copy link',
  'workingPanel.overview.ports.createFailed': 'Could not expose the port',
  'workingPanel.overview.ports.empty': 'No port exposed yet',
  'workingPanel.overview.ports.expose': 'Expose a port',
  'workingPanel.overview.ports.heading': 'Exposed ports',
  ...
  'workingPanel.overview.ports.revoke': 'Stop sharing',
  'workingPanel.overview.ports.revokeFailed': 'Could not stop sharing',
  ...
  'workingPanel.pr.header.changeBase': 'Change base branch',
  ...
  'workingPanel.pr.reason.behind': 'Branch is behind {{base}}',
  'workingPanel.pr.reason.changesRequested': 'Changes requested by {{authors}}',
  'workingPanel.pr.reason.checksFailing_one': '{{count}} required check failing',
  'workingPanel.pr.reason.checksFailing_other': '{{count}} required checks failing',
  'workingPanel.pr.reason.checksPending': 'Checks running',
  'workingPanel.pr.reason.conflicts': 'Conflicts with {{base}}',
  'workingPanel.pr.reason.localAhead_one': '{{count}} local commit not pushed',
  'workingPanel.pr.reason.localAhead_other': '{{count}} local commits not pushed',
  'workingPanel.pr.reason.localDirty_one': '{{count}} uncommitted file',
  'workingPanel.pr.reason.localDirty_other': '{{count}} uncommitted files',
  'workingPanel.pr.reason.optionalFailing_one': '{{count}} optional check failing',
  'workingPanel.pr.reason.optionalFailing_other': '{{count}} optional checks failing',
  'workingPanel.pr.reason.reviewRequired': 'Review required',
  'workingPanel.pr.reason.rules': 'Blocked by branch rules',
  'workingPanel.pr.status.autoMerge': 'Auto-merge enabled ({{method}})',
  'workingPanel.pr.status.blocked': 'Merging is blocked',
  'workingPanel.pr.status.bypass': 'Bypassing branch protection',
  'workingPanel.pr.status.calculating': 'Checking mergeability…',
  'workingPanel.pr.status.closed': 'Closed without merging',
  'workingPanel.pr.status.conflicts': 'This branch has conflicts with {{base}}',
  'workingPanel.pr.status.draft': 'Still a draft',
  'workingPanel.pr.status.error': 'Merge failed: {{message}}',
  'workingPanel.pr.status.merged': 'Merged',
  'workingPanel.pr.status.ready': 'Ready to merge',
  'workingPanel.pr.status.unstable': 'Some checks were not successful',
  'workingPanel.pr.status.waiting': 'Waiting for checks',
