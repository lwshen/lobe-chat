export default {
  ...
  'acceptance.review.mobileRegionCommentsEmpty':
    'Drag on the image above to mark a region. Its comment will appear here.',
  ...
  'acceptance.accept.exceptionsHint':
    'By accepting, you acknowledge these exceptions and take the delivery as is.',
  'acceptance.accept.exceptionsTitle': '{{count}} exception(s) still unresolved:',
  'acceptance.accept.summary':
    'Accept "{{title}}"? All verification rounds and their evidence will be archived as the acceptance record.',
  'acceptance.actionError': 'Couldn’t update this acceptance. Please try again.',
  ...
  'acceptance.banner.clean': 'All {{count}} round(s) passed — ready for your decision',
  'acceptance.banner.decisionHint':
    'The verdict is only a recommendation — the final decision is yours.',
  'acceptance.banner.exceptions':
    'Verification finished with {{count}} exception(s) for you to review',
  'acceptance.banner.liveHint':
    'You can review finished checks now and decide once the round completes.',
  'acceptance.banner.rejected': 'Rejected',
  'acceptance.banner.rejectedHint':
    'This acceptance reopens when the next verification round comes in.',
  'acceptance.banner.rejectedReason': 'Reason: {{reason}}',
  'acceptance.bar.addComment': 'Add note',
  'acceptance.bar.addCommentDescription':
    'A note on the whole delivery, for anything the queued feedback doesn’t cover. The next verification round will read it.',
  'acceptance.bar.copied': 'Copied — paste it into any agent to start the repair.',
  ...
  'acceptance.bar.progress':
    '{{done}} of {{total}} checks confirmed — {{rest}} awaiting your review',
  ...
  'acceptance.bar.rerunDrafted': 'Added to your composer — review and send it.',
  'acceptance.bar.rerunSent': 'Sent to the source conversation — the repair round is starting.',
  ...
  'acceptance.checks.finalRoundHint':
    'The final result and evidence come from this round — click to jump to it.',
  ...
  'acceptance.checks.introducedHint':
    'This check first appeared in that round — click to jump to it.',
  'acceptance.checks.iterated': 'Iterated {{count}}×',
  'acceptance.checks.iteratedHint':
    'This check evolved over {{count}} rounds; the latest round counts. See the iteration history for details.',
  'acceptance.checks.iterationHistory': 'Iteration history ({{count}} rounds)',
  'acceptance.checks.notRequired': 'Non-blocking',
  'acceptance.checks.notRequiredHint': 'Optional — a failure here doesn’t block acceptance.',
  'acceptance.checks.rerun': 'Verified in {{count}} rounds',
  'acceptance.checks.rerunHint': 'This check ran in {{count}} rounds; the latest result counts.',
  ...
  'acceptance.notFound.title': 'Acceptance not found',
  'acceptance.comments.title': 'Discussion',
  'acceptance.comments.moreActions': 'More actions',
  'acceptance.comments.placeholder': 'Comment on this delivery…',
  'acceptance.comments.removeOthers': 'Remove',
  'acceptance.comments.removeOthersConfirm':
    'Remove this comment by another member? It will disappear from the discussion.',
  ...
  'acceptance.comments.historicalRegions':
    '{{count}} region note(s) on evidence replaced by a later round',
  ...
  'acceptance.comments.regionMissing': 'Mark a region first.',
  ...
  'acceptance.comments.approveDescription':
    'This records your approval. It doesn’t change the acceptance status — only the owner can accept the delivery.',
  ...
  'acceptance.comments.withdrawDescription':
    'You can withdraw or re-approve any time while the round is open. Only your status when the owner decides counts.',
  ...
  'acceptance.feedback.history': 'Used by earlier rounds ({{count}})',
  ...
  'acceptance.focus.verifierDescription.notExecuted':
    'This check was not executed, so there is no agent judgment or evidence to accept.',
  ...
  'acceptance.focus.verifierDescription.uncertain':
    'The agent could not reach a confident judgment. Review the available evidence before deciding.',
  'acceptance.focus.judgeLabel': 'Agent verdict',
  ...
  'acceptance.group.allVerified': '{{passed}}/{{total}} verified and accepted',
  ...
  'acceptance.group.feedbackDescription':
    'Feedback on “{{label}}” as a whole, for concerns no single check covers. The next verification round will read it.',
  'acceptance.group.feedbackLabel': 'Group feedback',
  'acceptance.group.feedbackPlaceholder':
    'What should change here, and what do you expect instead…',
  ...
  'acceptance.history.jump': 'Round {{round}} — click to jump to it in Runs',
  ...
  'acceptance.review.annotate': 'Mark regions on the evidence',
  'acceptance.review.annotateHint': 'Drag on the image to mark a region, then add a note.',
  ...
  'acceptance.predict.inconclusive':
    'AI couldn’t reach a conclusion — there was no readable screenshot evidence, or the review request failed.',
  ...
  'acceptance.proposal.title': 'AI review · possibly unmet',
  ...
  'acceptance.review.fullscreen': 'Annotate in full screen',
  ...
  'acceptance.review.rejectedHint':
    'You rejected this check — the next round will address your feedback.',
  'acceptance.review.removeRegion': 'Remove this region',
  'acceptance.review.revertToAccept': 'Accept instead',
  'acceptance.review.revertToReject': 'Reject instead',
  ...
  'acceptance.roundStatus.failed': 'Failed',
  'acceptance.roundStatus.passed': 'Passed',
  'acceptance.roundStatus.repairing': 'Repairing',
  'acceptance.roundStatus.uncertain': 'Uncertain',
  ...
  'acceptance.resources.empty': 'No files yet. Evidence from each round will appear here.',
  ...
  'acceptance.workspace.batch.deleteConfirmDescription':
    'Delete the {{count}} selected acceptance(s)? Their verification rounds will be kept as standalone reports.',
  ...
  'acceptance.workspace.deleteConfirmDescription':
    'Delete the acceptance “{{title}}”? Its verification rounds will be kept as standalone reports.',
  ...
  'acceptance.workspace.emptyDetail.signInDescription': 'Sign in to view your acceptances.',
  ...
  'acceptance.workspace.merge.description':
    'Move the {{count}} checks from “{{title}}” into another acceptance. Choose the destination.',
  ...
  'acceptance.workspace.merge.settledHint': 'already decided — reopen it first',
  'acceptance.workspace.merge.hint':
    'The checks keep their verdicts, evidence and rounds. This acceptance is removed after the merge.',
  ...
  'report.evidence.count': '{{count}} evidence item(s)',
  ...
  'workspace.title': 'Verification reports',
  'flow.startVerification': 'Start verification',
  'flow.rerunVersion': 'Rerun this version',
  'flow.roundCreated': 'New round created. Checks are waiting to run.',
};
